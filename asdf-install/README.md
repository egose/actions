...
- Caches the installed `asdf` binary by runner OS, architecture, and requested version.
- Installs the `asdf` binary into the runner temp directory when it is not restored from cache.
